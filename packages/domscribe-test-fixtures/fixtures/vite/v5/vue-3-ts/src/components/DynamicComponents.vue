...
const ComponentA: Component = {
  template:
    '<div class="demo-box demo-box-blue"><strong>Component A</strong><p>I am the blue component!</p></div>',
};

const ComponentB: Component = {
  template:
    '<div class="demo-box demo-box-green"><strong>Component B</strong><p>I am the green component!</p></div>',
};

const ComponentC: Component = {
  template:
    '<div class="demo-box demo-box-amber"><strong>Component C</strong><p>I am the amber component!</p></div>',
};
