        ...
        <Transition name="fade">
          ...
          >
            ...
            >
              ...
              <p>
                This modal is rendered directly in the body element, not inside
                the component tree.
              </p>
    ...
    <section>
      ...
      <div class="demo-box demo-box-amber capture-widget">
        ...
        <div class="button-group">
          <button @click="showNotify('Success! Operation completed.')">
            Show Success
          </button>
          <button @click="showNotify('Warning! Check your input.')">
            Show Warning
          </button>
          <button @click="showNotify('Error! Something went wrong.')">
            Show Error
          </button>
        </div>
      </div>
