  ...
  <div>
    ...
    <section>
      ...
      <div class="demo-box capture-widget">
        ...
        <div class="demo-box" style="margin-top: 1rem">
          <p>
            <strong>Using v-show:</strong> Element stays in DOM with
            display:none
          </p>
    ...
    <section>
      ...
      <div class="demo-box capture-widget">
        <CaptureIcon />
        <button @click="isVisible = !isVisible">Toggle Group</button>
