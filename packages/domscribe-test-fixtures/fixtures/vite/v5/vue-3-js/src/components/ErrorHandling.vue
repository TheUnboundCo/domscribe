...
<template>
  <div>
    ...
    <section>
      ...
      <div class="demo-box demo-box-amber capture-widget">
        ...
        <div class="button-group">
          ...
          <button @click="triggerPromiseError">
        ...
        <p
          ...
          "
        >
          Note: Only sync errors in template/lifecycle are captured by
          onErrorCaptured. Check the browser console for async errors.
        </p>
      </div>
    </section>
    ...
    <section>
      ...
      <div
        class="demo-box capture-widget"
        :style="capturedError ? 'border-color: var(--color-error)' : ''"
      >
        <CaptureIcon />
