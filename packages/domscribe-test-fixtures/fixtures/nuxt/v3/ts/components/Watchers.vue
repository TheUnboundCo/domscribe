    ...
    <section>
      ...
      <div class="demo-box capture-widget">
        ...
        <div class="button-group">
          ...
          <button @click="updateMessage('World')">
            Set Message to "World"
          </button>
          <button @click="updateMessage('Hello')">
      ...
      <div class="demo-box capture-widget">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem">
          <div class="demo-box">
            ...
            <p v-else style="color: var(--color-text-tertiary)">
              No watch events yet
            </p>
          </div>
          <div class="demo-box">
