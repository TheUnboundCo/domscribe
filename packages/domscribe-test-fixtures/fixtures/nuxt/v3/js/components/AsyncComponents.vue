  ...
  () =>
    new Promise<Component>((resolve) => {
      setTimeout(() => {
        resolve({
          template:
            '<div class="demo-box demo-box-green"><strong>Basic Async Component Loaded!</strong><p>This component was loaded after a 1.5s delay.</p></div>',
        });
      }, 1500);
    }),
);
...
const AsyncWithOptions = defineAsyncComponent({
  loader: () =>
    new Promise<Component>((resolve) => {
      setTimeout(() => {
        resolve({
          template:
            '<div class="demo-box demo-box-blue"><strong>Full Options Async Component!</strong><p>Loaded with loading state handling.</p></div>',
        });
      }, 2000);
    }),
  loadingComponent: {
  ...
  errorComponent: {
    template:
      '<div class="demo-box" style="border-color: var(--color-error);"><strong>Error!</strong> Failed to load component.</div>',
  },
  delay: 200,
  timeout: 10000,
});
...
const AsyncWithError = defineAsyncComponent({
  ...
  errorComponent: {
    template:
      '<div class="demo-box" style="border-color: var(--color-error); background: rgba(239, 68, 68, 0.1);"><strong>Error!</strong> Component failed to load (simulated).</div>',
  },
  delay: 200,
});
