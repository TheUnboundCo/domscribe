  ...
  <div>
    ...
    <section>
      ...
      <div class="demo-box capture-widget">
        ...
        <p>
          Width: {{ divDimensions.width }}px, Height:
          {{ divDimensions.height }}px
        </p>
      </div>
    </section>
    ...
    <section>
      ...
      <div class="demo-box capture-widget">
        ...
        <button @click="clickButton">Click Button Programmatically</button>
      </div>
    </section>
    ...
    <section>
      ...
      <div class="demo-box capture-widget">
        <CaptureIcon />
        <p>
          Vue allows multiple refs in a component. Each gets its own reactive
          reference.
        </p>
        <div class="demo-box">
          ...
          <br />
          <code
            >const buttonRef = ref&lt;HTMLButtonElement | null&gt;(null)</code
          >
        </div>
      </div>
    </section>
    ...
    <section>
      ...
      <div class="demo-box demo-box-amber capture-widget">
        <CaptureIcon />
        <p>
          <strong>Important:</strong> Template refs are only available after the
