...
const components: ComponentConfig[] = [
  ...
  },
  {
    ...
    description: 'Client Component test component.',
    component: ClientComponent,
  },
  {
    id: 'dynamic-routes',
    title: 'Dynamic Routes',
    description: 'Dynamic Routes test component.',
    component: DynamicRoutes,
  },
  {
    id: 'image-optimization',
    title: 'Image Optimization',
    description: 'Image Optimization test component.',
    component: ImageOptimization,
  },
  {
    id: 'layout-pattern',
    title: 'Layout Pattern',
    description: 'Layout Pattern test component.',
    component: LayoutPattern,
  },
  {
    id: 'metadata',
    title: 'Metadata',
    description: 'Metadata test component.',
    component: Metadata,
  },
  {
    id: 'server-actions',
    title: 'Server Actions',
    description: 'Server Actions test component.',
    component: ServerActions,
  },
  {
    id: 'server-component',
    title: 'Server Component',
    description: 'Server Component test component.',
    component: ServerComponent,
  },
  {
    id: 'streaming',
    title: 'Streaming',
    description: 'Streaming test component.',
    component: Streaming,
  },
];
